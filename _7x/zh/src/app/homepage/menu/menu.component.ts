  ...
  readonly items = [
    ...
    },
    {
      ...
      children: [
        ...
        { title: '联合', path: '/graphql/federation' },
        { title: '迁移指南', path: '/graphql/migration-guide' },
      ],
    },
    {
      title: 'WebSockets',
      ...
      children: [
        ...
        { title: '管道', path: '/websockets/guards' },
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'CLI 命令参考', path: '/cli/usages' },
        { title: 'Nest CLI 与脚本', path: '/cli/scripts' },
      ],
    },
    {
      title: '开放 API',
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Passport (身份验证)', path: '/recipes/passport' },
        ...
        { title: 'Compodoc 文档', path: '/recipes/documentation' },
    ...
    },
    {
      ...
      children: [
        ...
        { title: '全局前缀', path: '/faq/global-prefix' },
    ...
    {
      title: 'API 参考',
      externalUrl:"https://api-references-nestjs.netlify.app/api"
    }
  ];
